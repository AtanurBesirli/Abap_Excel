...
FORM set_fcat .
  ...
  LOOP AT gt_fcat ASSIGNING <gfs_fcat>.
    CASE <gfs_fcat>-fieldname.
      WHEN 'MATNR'.
        <gfs_fcat>-coltext   = 'Malzeme Tanımı'.
        <gfs_fcat>-outputlen = 16.
      WHEN 'VBELN_VA'.
        <gfs_fcat>-coltext   = 'Sipariş Numarası'.
        <gfs_fcat>-outputlen = 12.
        <gfs_fcat>-hotspot   = 'X'.
      WHEN 'POSNR_VA'.
        <gfs_fcat>-coltext   = 'Sipariş Kalemi'.
        <gfs_fcat>-outputlen = 10.
      WHEN 'KWMENG'.
        <gfs_fcat>-coltext   = 'Miktar'.
        <gfs_fcat>-outputlen = 8.
      WHEN 'VRKME_VA'.
        <gfs_fcat>-coltext   = 'Birim'.
        <gfs_fcat>-outputlen = 6.
      WHEN 'NETWR'.
        <gfs_fcat>-coltext   = 'Tutar'.
        <gfs_fcat>-outputlen = 10.
      WHEN 'WAERK'.
        <gfs_fcat>-coltext   = 'Döküman'.
        <gfs_fcat>-outputlen = 8.
      WHEN 'VBELN_VL'.
        <gfs_fcat>-coltext   = 'Teslimat Numarası'.
        <gfs_fcat>-outputlen = 12.
        <gfs_fcat>-hotspot   = 'X'.
      WHEN 'POSNR_VL'.
        <gfs_fcat>-coltext   = 'Teslimat Kalemi'.
        <gfs_fcat>-outputlen = 10.
      WHEN 'LFIMG'.
        <gfs_fcat>-coltext   = 'Teslimat Miktarı'.
        <gfs_fcat>-outputlen = 12.
      WHEN 'VRKME_VL'.
        <gfs_fcat>-coltext   = 'Teslimat Numarası'.
        <gfs_fcat>-outputlen = 12.
      WHEN 'VBELN_VF'.
        <gfs_fcat>-coltext   = 'Fatura Numarası'.
        <gfs_fcat>-outputlen = 12.
        <gfs_fcat>-hotspot   = 'X'.
      WHEN 'POSNR_VF'.
        <gfs_fcat>-coltext   = 'Fatura Kalemi'.
        <gfs_fcat>-outputlen = 10.
    ENDCASE.
